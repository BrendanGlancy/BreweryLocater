...
'K�lsch Style Golden Ale', 'Light, clean, crisp with a slight citrusy, spicy character', 
...
'K�lsch Style Golden Ale', 'A bitter, floral and citrusy ale brewed with pale ale, light 
...
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('What is Jobu?',
'I dont know what Jobu is but this beer is pretty good',
3,now(), 6);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Not enough jobu',
...
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Holy Toledo Batman!',
'See, I got this reference at least',
4,now(), 7);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Not enough holy',
'I didnt get my holy for this. 2/10 would not reccomend',
1,now(), 7);

INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Put-in-Beautiful!',
'Great color, great taste, great beer!',
4,now(), 8);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Not enough berry',
...
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Millenials are cool still, right?',
'Right?',
4,now(), 9);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Not enough hipster',
...
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Big Chief (not keef)',
'Chief is big and this beer is good',
4,now(), 11);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Not enough big',
'I didnt get my big for this. 2/10 would not reccomend',
1,now(), 11);

INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Rally Possum is a great name',
'Thank you Brick and Barrel, very cool!',
5,now(), 12);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Not enough possum',
...
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Poni-Pina-Pinoe-Pinot Says-Saisi-Saison',
...
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('C-town sucks but this beer doesnt',
'Woo! Im drunk!',
4,now(), 14);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Not enough c',
...
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Hope this beer is always around',
'Hope flows freely and this beer should too',
5,now(), 15);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Not enough flows',
...
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Before 10? Yeah right!',
'This beer keeps me out all night!',
4,now(), 16);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Not enough 10',
...
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Can you get my favorite beer for me?',
'Oh, caaaaaaaan doo!',
5,now(), 22);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Not enough meseeks',
...
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('This stusff id amzzing!',
'Iv hwd 3 ifthes an i so drnk nw! Besht xms beeer yeh!',
4,now(), 31);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Not enough robot santa',
...
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Next',
'Almost had to spit it out',
1,now(),36);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Very interesting',
'Definatly has Alchol in it',
4,now(),36);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Buy This!',
'Excellent Brew, hopefully they keep making this!',
4,now(),37);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Average',
'Not my speed',
...
5,now(),38);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Not sure how the FDA approved of this one',
'My pet turtle seems to be very sick after giving him some of this.',
1,now(),39);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Very interesting',
...
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Pass',
'Great can, terrible beer though',
1,now(),42);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Very interesting',
'This is one of the most unique beers I have had, it tastes great too',
...
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('WOW',
'My wife left me because of this beer!',
5,now(),57);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('Next',
'Great can, but clowns are terrible, not as terrible as this beer though',
...
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('More my speed',
'Not a big beer fan but I love this one',
5,now(),66);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('HOLY GOODNESS',
'This beer is awesome!',
...
4,now(),68);
INSERT INTO reviews (name, description, rating, create_date, beer_id) VALUES
('It was not the worst, but definatly not the best.',
'Not my style',
4,now(), 68);
